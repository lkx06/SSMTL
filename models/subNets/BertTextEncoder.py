...
class BertTextEncoder(nn.Module):
    def __init__(self, language='en', use_finetune=False):
        ...
        self.linear_1 = nn.Linear(768+768, 768)
    ...
    def forward(self, text):
        ...
        #input_ids2, input_mask2, segment_ids2 = text2[:,0,:].long(), text2[:,1,:].float(), text2[:,2,:].long()
        ...
        #（32，64，768）
        #text0=last_hidden_states[:,0,:]
        #text1=last_hidden_states2[:,0,:]
        #text_output = torch.cat((text0, text1), dim=1)
        #y = self.linear_1(text_output)
