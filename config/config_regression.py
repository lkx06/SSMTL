...
class ConfigRegression():
    ...
    def __datasetCommonParams(self):
        root_dataset_dir = '/home/lkx/MMSA/Datasets'
        tmp = {
            'twitter':{
                'aligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'datapre_t.pkl'),
                    'seq_lens': (64,64,64),
                    # (text, audio, video)
                    'feature_dims': (768, 5, 224),
                    'train_samples': 3562,
                    'num_classes': 3,
                    'language': 'en',
                    'KeyEval': 'Loss' 
                ...
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'dataprerr_t_test.pkl'),
                    'seq_lens': (64,64,64),
                    # (text, audio, video)
                    'feature_dims': (768, 5, 768),
                    'train_samples': 3562,
                    'num_classes': 2,
                    'language': 'en',
                    'KeyEval': 'Loss' 
            ...
            'twitter2015':{
                'aligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'datapre2_t_non0.pkl'),
                    'seq_lens': (64,64,64),
                    # (text, audio, video)
                    'feature_dims': (768, 5, 224),
                    'train_samples': 3179,
                ...
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'datapre2rr_t_test.pkl'),
                    'seq_lens': (64,64,64),
                    # (text, audio, video)
                    'feature_dims': (768, 5, 768),
                    'train_samples': 3179,
        ...
        tmp = {
            ...
            'datasetParas':{
                'twitter':{
                    ...
                    #'learning_rate_video': 1e-4,改文本 88.25
